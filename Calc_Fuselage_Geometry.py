...
print(f"External Diameter: {diameterExternal / 12:.2f} ft")
print(f"Length of Business + Econ: {(lengthBusiness + lengthEcon) / 12:.2f} ft")
print(f"Length of Nose: {lengthNose / 12:.2f} ft")
print(f"Length Aft: {lengthAft / 12:.2f} ft")
