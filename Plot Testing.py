...
file_plot('Plots/Fig 3B.csv', 't/c', 't/c', 'Fig 3B')
file_plot('Plots/JT9D 15k.csv', 'Mach', 'Thrust (1k lbs)', 'JT9D 15kft')
file_plot('Plots/JT9D 35k.csv', 'Mach', 'Thrust (1k lbs)', 'JT9D 35kft')